...
$(function(){
		...
		items.forEach(function(item, index){
			html_template += `<li class="item" data-item-id="${item['id']}">
			    <a href="index.html?id=${item['id']}">
			      <div class="item-cap"><img src="../item/${item['id']}.png" loading="lazy"></div>
			      <div class="item-info">
	...
	if( page_type == 'page-detail' ){
		...
		$('#zoom-img').attr('src', `../item/${item_detail['id']}.png`);
		$('#zoom-img').attr('data-zoom-image', `..item/${item_detail['id']}_l.png`);
